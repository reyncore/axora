...
export function buildResetPasswordEmail(params: {
  ...
  return {
    to:      "",  // diisi caller
    subject: "Reset Password Axora",
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
        <div style="margin-bottom:24px">
          <span style="font-size:20px;font-weight:700;color:#7c3aed">⚡ Axora</span>
        </div>
        <h1 style="font-size:20px;font-weight:700;color:#e8e8ec;margin:0 0 8px">
          Reset password kamu
        </h1>
        <p style="color:#9999aa;margin:0 0 24px;line-height:1.6">
          Halo ${displayName}, kamu meminta reset password untuk akun Axora kamu.
        ...
        <p style="color:#9999aa;margin:24px 0 0;font-size:12px;line-height:1.6">
          Link ini berlaku selama <strong>1 jam</strong>. Jika kamu tidak meminta
          reset password, abaikan email ini — akun kamu tetap aman.
        </p>
        <p style="color:#666;font-size:11px;margin:8px 0 0">
          Atau copy link ini ke browser:<br/>
          <span style="color:#9999aa;word-break:break-all">${resetUrl}</span>
        </p>
      </div>
    `,
  }
