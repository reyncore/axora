...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const post   = await prisma.post.findUnique({
    ...
    select: {
      ...
      media:    { select: { fileUrl: true, type: true }, take: 1 },
    },
  })
  ...
  return {
    ...
    openGraph: {
      ...
      images: firstImage
        ? [{ url: firstImage.fileUrl, width: 1200, height: 630, alt: description }]
    ...
    twitter: {
      ...
      title,
      description,
      images:      firstImage ? [firstImage.fileUrl] : [`${appUrl}/og-default.png`],
